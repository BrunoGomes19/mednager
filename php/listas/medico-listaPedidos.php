...
function aceitarAssociacao($codComprador){
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if(result==true){
          window.location.replace('../associacao/aceitarAssociacaoMedico.php?cod='+$codComprador);
...
function rejeitarAssociacao($codComprador){
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if(result==true){
          window.location.replace('../associacao/rejeitarAssociacaoMedico.php?cod='+$codComprador);
                                                    ...
                                                    if ($result2->num_rows > 0) {
                                                        ...
                                                        while($row = $result2->fetch_assoc()) {
                                                          ...
                                                          echo '<tr class="tr-shadow">
                                                              ...
                                                              <button class="btn btn-primary btn-sm" style="font-size:16px" title="Clique para aceitar a associação" onclick="aceitarAssociacao('.$codComprador.')";>
                                                                  <i class="fas fa-check"></i>
                                                              </button>&nbsp

                                                              <button class="btn btn-danger btn-sm" style="font-size:16px" title="Clique para rejeitar a associação" onclick="rejeitarAssociacao('.$codComprador.')";>
