...
window.location.replace('../perfis/perfil_adminutentelista.php?cc='+$cc);
}
...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","ajaxadmin-lu.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h3 class="title-5 m-b-35" style="text-align: center">Lista de utentes registados</h3>
