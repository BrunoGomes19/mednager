...
$sql2 = "select * from associados, comprador, especialidade where associados.comprador_codComprador = comprador.codComprador and associados.utente_ccUtente = $cc and comprador.codEspecialidade = especialidade.codEspecialidade and confirmacao=1;";
...
function removerAssociacao($ccUtente,$codComprador){
  ...
  bootbox.confirm({
    ...
    callback: function (result) {
      if(result==true){
          window.location.replace('../associacao/removerAssociacao.php?cc='+$ccUtente+'&cod='+$codComprador);
...
<h3 class="title-5 m-b-35" style="text-align:center;">Lista de médicos associados</h3>
<br>


<div class="rs-select2--dark rs-select2--sm rs-select2--dark2" style="float:right;padding-right:12%;">

                <form action="utente-listaPedidos.php" method="POST">
                                                    ...
                                                    if ($result2->num_rows > 0) {
                                                        ...
                                                        while($row = $result2->fetch_assoc()) {
                                                          ...
                                                          echo '<tr class="tr-shadow">
                                                              ...
                                                              <button class="btn btn-danger btn-sm" style="font-size:16px" title="Clique para remover a associação" onclick="removerAssociacao('.$ccUtente.','.$codComprador.')";>
