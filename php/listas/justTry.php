                                        ...
                                        <div class="table-data__tool-left">
                                            <div class="rs-select2--light ">
                                                   ...
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" id="input1-group2" name="input1-group2" placeholder="nome do medicamento de pediatria" class="form-control" onkeyup="todosMedicamentos(this.value)">
                                                    </div>                                            
