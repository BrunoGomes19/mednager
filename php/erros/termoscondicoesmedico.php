...
Recepção de dados:
Ao ceder-nos a sua informação pessoal, voluntariamente, ela apenas será acedida pelos nossos serviços. É considerado informação pessoal tudo o que possa ser usado para identificar um utilizador como, por exemplo, nome, email, número de Ordem, número do cartão de cidadão, número de indentificação bancária, número de identificação fiscal, data de nascimento, género, morada, contacto telefónico, interesses pessoais ou demais dados necessários para que possamos prestar o serviço solicitado ou até melhorar o funcionamento do Site. Não registamos automaticamente informação pessoal, incluindo o seu endereço de IP. Os dados fornecidos poderão ser transferidos para terceiros para efeitos meramente estatísticos.
